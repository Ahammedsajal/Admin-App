...
class StateOrder extends State<OrderDetail> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    Widget prescriptionImage() {
      // If there are no images, return an empty widget to avoid extra space
      if (widget.model?.orderAttachment == null ||
          widget.model!.orderAttachment!.isEmpty) {
      ...
      return Card(
        child: Column(
          ...
          children: [
            Text(
              getTranslated(context, PRESCRIPTION_ATTACHMENET)!,
                ...
                Expanded(
                  child: SizedBox(
                    ...
                    child: ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount: widget.model!.orderAttachment!.length > 5
                          ? 5
                          : widget.model!.orderAttachment!.length,
                      itemBuilder: (context, index) {
                        final bool isLastItem = index == 4 &&
                            widget.model!.orderAttachment!.length > 5;
                        ...
                        return Padding(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              if (isLastItem) {
                                // Show all images in a popup grid when clicking on the last item
                                showDialog(
                                  context: context,
                                      ...
                                      child: GridView.builder(
                                        ...
                                        itemBuilder: (context, i) {
                                          return Image.network(
                                            widget.model!.orderAttachment![i]!,
                                          );
                                        },
                                      ),
                                    ),
                                ...
                                showDialog(
                                  ...
                                  builder: (context) => Dialog(
                                    child: Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Image.network(
                                        widget.model!.orderAttachment![index]!,
                                        errorBuilder:
                            ...
                            children: [
                              ...
                              ListView.builder(
                                ...
                                itemBuilder: (context, i) {
                                  ...
                                  print(
                                    "itemAttachments len****${model.orderAttachment}",
                                  );
                              ...
                              if (model.payMethod == "Bank Transfer")
                                bankProof(model)
                              else
                                Container(),
                              prescriptionImage(),
          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  if ((widget.model?.promoDis ?? '').isNotEmpty &&
    widget.model!.promoDis != '0') ...[
  Padding(
    padding: const EdgeInsets.only(left: 15.0, right: 15.0),
    child: Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        ...
                        child: SizedBox(
                          ...
                          child: ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              ...
                              disabledForegroundColor:
                                  fontColor.withValues(alpha: 0.38),
                              disabledBackgroundColor:
                                  fontColor.withValues(alpha: 0.12),
                            ),
                            onPressed: () {
                              Navigator.push(
                                context,
