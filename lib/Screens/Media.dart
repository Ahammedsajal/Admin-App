...
class _MediaState extends State<Media> with TickerProviderStateMixin {
  ...
  Future<void> uploadMediaAPI() async {
    ...
    print("Selected image path: ${selectedImageFromGellery?.path}");
    if (_isNetworkAvail) {
      try {
            ...
            children: [
              ...
              if (selectedImageFromGellery == null)
                ...
                InkWell(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: const Color.fromARGB(255, 51, 189, 63),
                      borderRadius: BorderRadius.circular(5),
                    ),
                    width: 120,
                    height: 40,
              ...
              if (uploadedVideoName == null)
                ...
                InkWell(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: const Color.fromARGB(255, 189, 51, 51),
                      borderRadius: BorderRadius.circular(5),
                    ),
                    width: 120,
                    height: 40,
  ...
  AppBar getAppBar(String title, BuildContext context) {
    return AppBar(
      ...
      actions: [
        if (widget.from == "other" || widget.from == 'variant')
          TextButton(
            onPressed: () {
      ...
      child: InkWell(
        ...
        child: Stack(
          children: [
              ...
              children: [
                Image.network(
                  ...
                  color: fontColor.withValues(
                      alpha: mediaList[index].isSelected ? 1 : 0),
            ...
            Container(
              color: fontColor.withValues(
                  alpha: mediaList[index].isSelected ? 0.1 : 0),
            ),
            if (mediaList[index].isSelected)
              const Align(
